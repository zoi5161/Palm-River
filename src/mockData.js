const mockData = {
  logo: "/images/logo-ngang",
  logoVertical: "/images/logo-doc",
  logoGroup: "/images/logo-group",
  name: "Palm River",
  eyebrow: "Căn hộ cao tầng view sông khu Đông TP.HCM",
  shortDescription:
    ...
    items: [
      {
        ...
        description:
          "Tọa lạc tại khu vực phát triển trọng điểm khu Đông thành phố, hạ tầng giao thông hiện đại kết nối nhanh chóng mọi tiện ích.",
      },
      {
        title: "Cảm hứng từ dòng chảy của nước",
        description:
          "Thiết kế lấy cảm hứng từ biểu tượng của nước, không gian sống rộng mở hòa nhịp cùng dòng sông.",
      },
      {
        title: "Đa dạng loại hình sản phẩm",
        description:
          "Từ Studio, 1PN, 2PN đến Duplex, Penthouse và Shophouse - đáp ứng mọi nhu cầu an cư và đầu tư.",
      },
    ],
  },
  amenities: {
    ...
    images: [
      ...
      { src: "/images/tien-ich-2", caption: "Phòng Golf" },
      { src: "/images/tien-ich-3", caption: "Phòng Gym" },
      { src: "/images/tien-ich-4", caption: "Khu vui chơi trẻ em" },
      { src: "/images/tien-ich-5", caption: "Khu tiệc nướng BBQ trên cao" },
      { src: "/images/tien-ich-6", caption: "Phòng xông hơi" },
      { src: "/images/tien-ich-7", caption: "Sân chơi cho thú cưng" },
      { src: "/images/tien-ich-8", caption: "Phòng massage trị liệu" },
      { src: "/images/tien-ich-9", caption: "Rạp chiếu phim" },
    ],
  },
  floorPlan: {
    ...
    items: [
      {
        title: "Căn hộ Studio",
        description:
          "Thiết kế tối ưu công năng trong không gian gọn gàng, phù hợp cho người độc thân hoặc nhà đầu tư khai thác cho thuê.",
        specs: [
      ...
      },
      {
        ...
        description:
          "Không gian sống riêng tư trọn vẹn, phù hợp cho cặp đôi trẻ hoặc gia đình nhỏ mới bắt đầu an cư.",
        specs: [
      ...
      },
      {
        ...
        description:
          "Căn góc đón trọn ánh sáng và view sông hai mặt thoáng, phù hợp cho gia đình cần không gian riêng tư và rộng rãi hơn.",
        specs: [
      ...
      },
      {
        ...
        description:
          "Phiên bản cao cấp nhất trong dòng 2 phòng ngủ, diện tích rộng rãi 120,2m² với thiết kế đặc biệt, view sông trọn vẹn.",
        specs: [
    ...
    items: [
      {
        ...
        description:
          "Kết nối nhanh chóng tới trung tâm tài chính Thủ Thiêm, sân bay Long Thành và các trục giao thông trọng điểm.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Từ Studio, căn hộ gia đình đến Penthouse, Shophouse - linh hoạt cho cả nhu cầu ở thực và đầu tư khai thác.",
      },
    ],
  },
  buyers: {
    ...
    items: [
      {
        ...
        answer:
          "Palm River đa dạng loại hình: Studio (41,3m²), 1 Phòng ngủ (65,9m²), 2 Phòng ngủ góc (84,9m²), 2 Phòng ngủ đặc biệt (120,2m²), cùng Duplex, Penthouse và Shophouse.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Dự án cách Trung tâm Tài chính Thủ Thiêm (IFC) 10 phút, Trung tâm Hành chính TP.HCM 10 phút và khu trung tâm Quận 1 cũ khoảng 12 phút di chuyển.",
      },
      {
